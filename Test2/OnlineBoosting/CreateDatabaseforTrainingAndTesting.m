function [dataClass, RatioInsecureOCInStableOC] = CreateDatabaseforTrainingAndTesting(percentageForTraining,measurementdata,operatingConditionData,xtrainName,ytrainName,xtestName,ytestName)
