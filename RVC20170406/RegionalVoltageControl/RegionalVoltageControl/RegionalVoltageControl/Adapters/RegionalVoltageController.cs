...
using RegionalVoltageControl.PythonScripts;
...
namespace RegionalVoltageControl
{
    ...
    public class RegionalVoltageControllerAdapter
    {
        ...
        private string m_pythonCMDForControl;

        #endregion

        #region [ Properties ]
        public string PythonCMDForControl
        {
            get
            {
                return m_pythonCMDForControl;
            }
            set
            {
                m_pythonCMDForControl = value;
            }
        }
